...
/**
 * A Book object stores metadata about a particular book, including authorship and copyright info.
 */
public class Book implements Serializable {
    ...
    public String display() {
        return String.format("\"%s\", a %s book, written by %s and released in %d",
                title, bookGenre.display(), authorName, yearReleased);
    }
}
